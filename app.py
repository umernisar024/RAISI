...
# ══════════════════════════════════════════════════════════════════════════════
# MAIN PAGE FUNCTION
# All app content lives here.  st.navigation() (below) calls this function
# as the current page.  Keeping it as a function lets us pass it to
# st.Page() and control sidebar nav with position="hidden" before login.
# ══════════════════════════════════════════════════════════════════════════════
